package prueba.bith.net.web.rest;
...
import static prueba.bith.net.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import prueba.bith.net.repository.AuthorityRepository;
import prueba.bith.net.repository.PersistentTokenRepository;
import prueba.bith.net.repository.UserRepository;
import prueba.bith.net.security.AuthoritiesConstants;
import prueba.bith.net.service.UserService;
import prueba.bith.net.service.dto.PasswordChangeDTO;
import prueba.bith.net.service.dto.UserDTO;
import prueba.bith.net.web.rest.vm.KeyAndPasswordVM;
import prueba.bith.net.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhipsterHolaMundoApp.class)
